...
input_shape_cnn = (X_intra_train.shape[1], X_intra_train.shape[2], 1)
...
plt.title('standalone CNN: Training and Validation Loss INTRAdata')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
# Plotting training and validation accuracy
...
plt.title('standalone CNN: Training and Validation Accuracy INTRAdata')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
...
plt.title('standalone LSTM: Training and Validation Loss INTRAdata')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
# Plotting training and validation accuracy
...
plt.title('standalone LSTM: Training and Validation Accuracy INTRAdata')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
...
plt.title('standalone CNN: Training and Validation Loss CROSSdata')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
# Plotting training and validation accuracy
...
plt.title('standalone CNN: Training and Validation Accuracy CROSSdata')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
...
plt.title('standalone LSTM: Training and Validation Loss CROSSdata')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
# Plotting training and validation accuracy
...
plt.title('standalone LSTM: Training and Validation Accuracy CROSSdata')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
